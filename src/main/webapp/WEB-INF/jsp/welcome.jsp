...
<section id="container" >
        ...
        <section class="wrapper">
                ...
                <div class="col-lg-5">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div style="overflow-y: scroll;height: 320px;margin: -15px -15px 0 0" class="tab-content tasi-tab">
                                <div class="tab-pane active" id="popular">
                                    <article class="media">
                                        ...
                                        <div class="media-body">
                                            <a class="p-head" href="javascript:void(0);" target="_blank">
                                                尊敬的 <span id="username"></span>，
                                                <span id="hello"></span>
                                                现在时间是：<span id="currentTime"></span></a>
                                            <p><br>这是通过Github获得的一个开源项目，对该项目的后台进行了独立的实现
                                            </p>
                                        </div>
                                    </article>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            <a href="javascript:void(0);" target="_blank" class="task-thumb">
                                <img width="83px" height="83px" src="lib/pivture/1203.jpg" alt="">
                            </a>
                            <div class="task-thumb-details">
                                <h1><a href="javascript:void(0);" target="_blank">果小呆</a></h1>
                                <p>Author</p>
                            </div>
                        </div>
                        <table class="table table-hover personal-task">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0);" target="_blank">1219465631@qq.com</a>
                                </td>
                    ...
                    <section class="panel">
                        ...
                        <table class="table table-hover personal-task">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-important">100%</span>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>5</td>
                                <td>
                                    <a href="javascript:void(0);" target="_blank">无</a>
                                </td>
                                <td>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <!--timeline start-->
                    <section class="panel">
                        <div style="height: 576px" class="panel-body">
                                    ...
                                    <div class="timeline-desk">
                                        <div class="panel">
                                            <div class="panel-body">
                                                ...
                                                <h1 class="green">2 Sept | Sunday</h1>
                                                <p><a href="javascript:void(0);" target="_blank">果小呆</a> 完成目前所有功能开发 <span><a href="javascript:void(0);" class="green" target="_blank">v1.0发布</a></span></p>
                                            </div>
                                        </div>
                                    </div>
                                </article>
                                    ...
                                    <div class="timeline-desk">
                                        <div class="panel">
                                            <div class="panel-body">
                                                ...
                                                <h1 class="light-green">20 Aug | Monday</h1>
                                                <p><a href="javascript:void(0);" target="_blank">果小呆</a> 启动了
                                                    <span><a href="javascript:void(0);" target="_blank" class="light-green">XMall</a></span>
                                                    后台管理项目，并完成第一次提交</p>
                                            </div>
                                        </div>
                                    </div>
    ...
    <footer class="site-footer">
        <div class="text-center">
            Copyright &copy;2017 <a href="javascript:void(0);" target="_blank">guoxiaodai.com</a> All Rights Reserved.
