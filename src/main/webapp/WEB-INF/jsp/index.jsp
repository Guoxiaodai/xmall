            ...
            <nav class="nav navbar-nav">
                <ul class="cl">
                    <li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
                        ...
                        <li ><a href="javascript:void(0);" target="_blank">XPay支付系统</a></li>
                        <li ><a href="javascript:void(0);" target="_blank">商城前台</a></li>
                    </li>
                </ul>
            </nav>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-picture">
            ...
            <dd>
                <ul>
                    <li><a data-href="javascript:void(0);" data-title="首页缓存管理" href="javascript:void(0)">首页缓存管理</a></li>
                    <li><a data-href="javascript:void(0);" data-title="其它板块缓存管理" href="javascript:void(0)">其它板块缓存管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-product">
        ...
        <dl id="menu-search">
            ...
            <dd>
                <ul>
                    <li><a data-href="javascript:void(0);" data-title="同步索引" href="javascript:void(0)">同步索引</a></li>
                    <li><a data-href="javascript:void(0);" data-title="词典库管理" href="javascript:void(0)">词典库管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-comments">
        ...
        <dl id="menu-chart">
            ...
            <dd>
                <ul>
                    <li><a data-href="javascript:void(0);" data-title="订单销量统计" href="javascript:void(0)">订单销量统计</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-system">
            ...
            <dd>
                <ul>
                    ...
                    <li><a data-href="javascript:void(0);" data-title="快递管理" href="javascript:void(0)">快递管理</a></li>
                    <li><a data-href="system-shiro" data-title="权限配置" href="javascript:void(0)">权限配置</a></li>
                    <li><a data-href="javascript:void(0);" data-title="系统日志" href="javascript:void(0)">系统日志</a></li>
                </ul>
            </dd>
        </dl>
    </div>
