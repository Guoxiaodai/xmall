...
<div>
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 商城管理 <span
            class="c-gray en">&gt;</span> 导航栏管理 <a class="btn btn-success radius r"
    ...
    <form class="page-container">
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                ...
                <a class="btn btn-primary radius" onclick="add('添加导航栏内容','content-header-add',700,350)"
                   href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加导航栏内容</a>
            </span>
        </div>
        <div class="mt-20">
